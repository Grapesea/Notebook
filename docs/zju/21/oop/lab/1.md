...
1. The result correctness<br>
2. C++ code quality (compact and reasonable)<br>
3. Comments quality (clean and accurate)<br>
4. C functions like printf and scanf are not allowed<br>
