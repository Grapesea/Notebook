...
> * Network预处理的技巧：
>     * Run random walks on modified versions of the original network: [struc2vec: Learning Node Representations from Structural Identity](https://arxiv.org/pdf/1704.03165)  [HARP: Hierarchical Representation Learning for Networks](https://arxiv.org/abs/1706.07845)
