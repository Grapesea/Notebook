...
<img src="./figures/1-6/storage_hierarchy.svg" alt="storage_hierarchy" style="zoom:67%;" />
...
![3ptypes](./figures/1-6/3ptypes.svg)
...
![heap_file_page_directory](./figures/1-6/heap_file_page_directory.svg)
...
![slotted_page_layout](./figures/1-6/slotted_page_layout.svg)
...
![tuple_layout](./figures/1-6/tuple_layout.svg)
...
![buffer_pool_overview](./figures/1-6/overview.svg)
...
![page_table_metadata](./figures/1-6/page_table_metadata.svg)
...
![clock_algo](./figures/1-6/clock_algo.png)
...
![dirty_page_eviction](./figures/1-6/dirty_page_eviction.svg)
...
![prefetching_scenarios](./figures/1-6/prefetching_scenarios.svg)注意：预取的是**逻辑上的下一页**（比如索引叶子节点的下一个），不一定是磁盘上物理位置相邻的 page.
...
![tuple_oriented_problems](./figures/1-6/tuple_oriented_problems.svg)
...
- 对于 PUT：tuple 的实际内容
    ...
    ![log_structured_write_path](./figures/1-6/log_structured_write_path.svg)
...
![index_organized_storage](./figures/1-6/index_organized_storage.svg)
...
![storage_model_comparison](./figures/1-6/storage_model_comparison.svg)总结：Note 5 核心考点
